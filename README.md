...
- **网络监控区**：多网卡「网口1/2/3/4」标签页切换，每口显示 IPv4/IPv6、MAC、实时收发速率、协商速率/双工/MTU、厂商/驱动/PCI 位置、UP/DOWN 状态
- 磁盘 I/O（读写速率）

> 温度 / 风扇 / 电压已挪到「温度监控」「风扇控制」专属页面（v2.0.4 起），本页聚焦 CPU/内存/功耗/网络。

### 🌡️ 温度监控
- 顶部 hero 四个数：**CPU 温度 / 阵列卡温度 / 最高温度 / 平均温度**
- 温度墙网格：主板所有温度测点 + 各硬盘温度，按 核心/NVMe/SSD/机械 分组展示，统一高度对齐；绿=正常 / 橙=偏高 / 红=危险
