...
**当前版本：v1.8.6** · [下载最新 fpk](https://github.com/han951meng/nasdash/releases/latest) · [📖 操作手册](docs/使用手册.md)
...
### v1.8.3
- 移动端适配：左侧导航改为可隐藏抽屉式（汉堡菜单+遮罩），阵列卡/风扇控制/Docker 等页面的宽表格改为横向滚动而非撑破页面，手机上不再需要拖动查看全部内容
