...
**当前版本：v1.6.7** · [下载最新 fpk](https://github.com/han951meng/nasdash/releases/latest)
...
### v1.6.6
- 风扇控制独立成左侧「🌀 风扇控制」监控模块并重做版式：顶部预设档位条（默认 / 全速 / 10% / 20% / 30% … 90%）一键应用到全部风扇，下方每张风扇卡片实时显示 RPM、当前/目标占空比与细调滑块；手动调速下限放宽至 10%。
