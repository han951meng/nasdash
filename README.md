...
- **风扇转速**：读取 FanControlServer 配置获取风扇名称和控制模式（曲线温控/手动等），0 RPM 停转风扇标红显示
...
| 风扇名称/模式 | `/vol2/@appconf/FanControlServer/config.json` |
| 显卡 | `lspci` |
...
- 风扇名称依赖 FanControlServer 应用配置（未安装时显示默认名称）
- 端口 9800（飞牛OS 应用框架分配）
